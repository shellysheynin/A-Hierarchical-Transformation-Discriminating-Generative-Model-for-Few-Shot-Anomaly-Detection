...
def download_class_mnist(opt):
    ...
    path = "mnist_test_scale" + str(scale) + "_" + str(pos_class)
    if os.path.exists(path) == False:
        ...
        np.save(path + "/mnist_data_test_" + str(pos_class) + str(scale) + ".npy", test_data)
        np.save(path + "/mnist_labels_test_" + str(pos_class) + str(scale) + ".npy", mnist_target_new)
