...
def download_class_cifar(opt):
    ...
    path = "cifar_test_scale" + str(scale) + "_" + str(pos_class)
    if os.path.exists(path) == False:
        ...
        np.save(path + "/cifar_data_test_" + str(pos_class) + str(scale) + ".npy", test_data)
        np.save(path + "/cifar_labels_test_" + str(pos_class) + str(scale) + ".npy", cifar_target_new)
